...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C68() {
      return C[68] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4284136959.0
      });
    },
    get C69() {
      return C[69] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4288860927.0
      });
    },
    get C70() {
      return C[70] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4291671259.0
      });
    },
    get C71() {
      return C[71] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4290633982.0
      });
    },
    get C72() {
    ...
    get C74() {
      return C[74] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4278223271.0
      });
    },
    get C75() {
      return C[75] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4294835420.0
      });
    },
    get C76() {
      return C[76] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4294891959.0
      });
    },
    get C77() {
      return C[77] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4293947751.0
      });
    },
    get C78() {
      return C[78] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4278221823.0
      });
    },
    get C79() {
      return C[79] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4285298045.0
      });
    },
    get C80() {
      return C[80] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4280854341.0
      });
    },
    get C81() {
      return C[81] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4292621637.0
      });
    },
    get C82() {
    ...
    get C83() {
      return C[83] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4279739064.0
      });
    },
    get C84() {
      return C[84] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4294507002.0
      });
    },
    get C85() {
      return C[85] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4281612864.0
      });
    },
    get C87() {
  ...
  styles.outlineInputBorder = function outlineInputBorder() {
    return new input_border.OutlineInputBorder.new({borderRadius: new border_radius.BorderRadius.circular(15.0), borderSide: new borders.BorderSide.new({color: colors$0.kAppPrimary})});
  };
  ...
  dart.defineLazy(styles, {
    ...
    /*styles.kHeadingStyle*/get kHeadingStyle() {
      return new text_style.TextStyle.new({fontSize: 21.0, fontWeight: ui.FontWeight.bold, color: colors.Colors.black, height: 1.5});
    },
    /*styles.otpInputDecoration*/get otpInputDecoration() {
      return new input_decorator.InputDecoration.new({contentPadding: new edge_insets.EdgeInsets.symmetric({vertical: 15.0}), border: styles.outlineInputBorder(), focusedBorder: styles.outlineInputBorder(), enabledBorder: styles.outlineInputBorder()});
    }
  }, false);
  ...
  home_pg.HomePage = class HomePage extends framework.StatelessWidget {
    ...
    build(context) {
      ...
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({elevation: 0.0, title: new text.Text.new("Home Page")}), body: new single_child_scroll_view.SingleChildScrollView.new({child: new basic.Padding.new({padding: C[103] || CT.C103, child: new basic.Column.new({children: T$.JSArrayOfWidget().of([new basic.SizedBox.new({width: size.width * 0.5, child: button_wdg.MyButtons.primary(context, "Primary with SizedBox", dart.fn(() => core.print("Primary"), T$.VoidTovoid()))}), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primary(context, "Primary", dart.fn(() => core.print("Primary"), T$.VoidTovoid())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.warning(context, "Warning", dart.fn(() => core.print("Warning"), T$.VoidTovoid())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.danger(context, "Danger", dart.fn(() => core.print("Danger"), T$.VoidTovoid())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primaryOutlined(context, "Primary Outlined", dart.fn(() => core.print("Primary Outlined"), T$.VoidTovoid())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.dangerOutlined(context, "Danger Outlined", dart.fn(() => core.print("Danger Outlined"), T$.VoidTovoid())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primaryGradiented(context, "Primary Gradiented", dart.fn(() => {
                  core.print("Primary Gradiented");
                }, T$.VoidToNull())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primary(context, "Show Primary Snackbar", dart.fn(() => {
                  core.print("--Clicked: Show Snackbar");
                  snackbar_wdg.MySnackbar.primary(context, "Hello", "Mabroook");
                }, T$.VoidToNull())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.danger(context, "Show Danger Snackbar", dart.fn(() => {
                  core.print("--Clicked: Show Snackbar");
                  snackbar_wdg.MySnackbar.danger(context, "Upps", "Error Detected");
                }, T$.VoidToNull())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primaryOutlined(context, "Show Dialog", dart.fn(() => {
                  core.print("Show Dialog");
                  dialog_wdg.MyDialogs.alert(context, "Dialog", "How are you Dialog?");
                }, T$.VoidToNull())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primaryOutlined(context, "Show Alert Dialog", dart.fn(() => {
                  core.print("Show Alert Dialog");
                  dialog_wdg.MyDialogs.alert2(context, "AlertDialog", "How are you AlertDialog?");
                }, T$.VoidToNull())), new basic.SizedBox.new({height: 5.0}), button_wdg.MyButtons.primaryGradiented(context, "Show Loading", dart.fn(() => {
  ...
  styles$.outlineInputBorder = function outlineInputBorder$() {
    return new input_border.OutlineInputBorder.new({borderRadius: new border_radius.BorderRadius.circular(15.0), borderSide: new borders.BorderSide.new({color: colors$1.kAppPrimary})});
  };
  dart.defineLazy(styles$, {
    /*styles$.kDefaultShadow*/get kDefaultShadow() {
      return C[95] || CT.C95;
